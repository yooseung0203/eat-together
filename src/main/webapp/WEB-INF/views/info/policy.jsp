...
<h3 class="policy-title">맛집갔다갈래 이용약관</h3>
</div>
</div>
<div class="row">
...
<br>
제 1 조 (목적) <br>
본 약관은 TEAM COMA(코딩맛집)이 운영하는 웹 사이트 '맛집갔다갈래' (http://eat-together.net)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.<br>
<br>
제 2 조 (용어의 정의)<br>
