		...
		<div id="sideBar">
			<div class="search_area">
				<div class="category_search_btns mx-auto">
					<div class="search_btn" id="foodBtn"><img src="/resources/img/fork.png" style="height:20px;"></div>
					<div class="search_btn" id="cafeBtn"><img src="/resources/img/food.png" style="height:20px;"></div>
				</div>
