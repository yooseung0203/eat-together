				...
				.on(
						...
						function() {
							...
							if (nickname == "") {
								...
								$
										.ajax({
											url : '../memreport/duplCheck?nickname='
													+ nickname,
											dataType : 'json',
	...
	<div class="container" align="center">
		<form id="report" action="/memreport/insertReport" method="post">
			<table class="table">
				...
				<tbody>
					<tr align="center">
						<th scope="col" colspan=12>신고자 닉네임 : ${nick } <input
							type="hidden" name="id" value="${nick }"></th>

					</tr>
					<tr align="center">
						<th scope="col" colspan=4>신고 닉네임</th>
						<td scope="col" colspan=8><input type="text" name="report_id"
							id="report_id"> <input type="button" id="idcheck"
							value="확인"></td>
					</tr>
					<tr align="center">
						<th scope="col" colspan=4>제목</th>
						<td scopt="col" colspan=8><input type="text" name="title"
							id="title"></td>
					</tr>
					<tr align="center">
					...
					<tr align="center">
						<td scope="col" colspan=12><textarea
								placeholder="신고 사유를 최대한 자세히 작성해 주세요."
